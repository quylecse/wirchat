...
export function SignInForm({
  ...
  const onSubmit = async (data: SignInFormValues) => {
    try {
      ...
      console.error("Đăng nhập thất bại, đã ngăn điều hướng.", error);
    }
  };
  return (
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-6">
              ...
              <div className="text-sm text-balance text-center *:[a]:hover:text-primary text-muted-foreground *:[a]:underline *:[a]:underline-offset-4">
                Indem du auf „Weiter“ klickst, stimmst du unseren{" "}
                <a href="#">Nutzungsbedingungen</a> und{" "}
                <a href="#">Datenschutzrichtlinie</a> zu.
              </div>
